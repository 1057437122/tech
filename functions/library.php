...
<ul class="socialnet">
	<li class="rss">
		<a href="<?php echo $padd_sb_feedburner; ?>" title="RSS Feed">RSS</a>
	</li>
	<li class="facebook">
		<a href="<?php echo $padd_sb_facebook; ?>" class="icon-facebook" title="Facebook Profile">Facebook</a>
	</li>
	<li class="twitter">
		<a href="<?php echo $padd_sb_twitter; ?>" class="icon-twitter" title="Twitter Page">Twitter</a>
	</li>
</ul>
<?php
}
...
function padd_theme_widget_sponsors() {
	global $ad_default_250;
	$sqbtn_1 = unserialize(get_option(PADD_NAME_SPACE . '_ads_250250_1'));
	$sqbtn_1 =$sqbtn_1->is_empty()  ? $ad_default_250 : $sqbtn_1; 
	echo $sqbtn_1;
}
	...
	<?php while (have_posts()) : the_post(); ?>
		<div class="item append-clear">
			...
			<div class="meta">
				...
				<p class="date"><span><?php the_time('M j, Y'); ?></span></p>
				<?php the_excerpt(); ?>
			</div>
		</div>
	<?php endwhile; ?>
